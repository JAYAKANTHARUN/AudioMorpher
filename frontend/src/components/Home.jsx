                ...
                <div className='h-[100vh] text-center'>
                    ...
                    <div className='grid sm:grid-cols-3 grid-cols-2 sm:mx-[50px] mx-[5px] '>
                        ...
                        <div className='sm:h-[30vh] sm:w-[50vh] h-[27vh] w-[22vh] border-[1px] mx-auto bg-[#B9B4C7] drop-shadow-2xl rounded-3xl transition-all duration-200 ease-in-out  transform hover:scale-105 cursor-pointer hover:bg-[#cfccd8] '>
                            ...
                            <h1 className='font-poppins font-bold sm:text-[20px] text-[13px] text-[#352F44] sm:my-[15px] -mt-[8px] mb-[5px] '>Split Audio</h1>
